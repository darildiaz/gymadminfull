            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('images/portfolio-4.jpg') }}" alt="fgsfgsdfdgsfgsfd">
      ...
      <div class="swiper mySwiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide flex flex-col space-y-4">
            <img class="w-20 h-20 rounded-full mx-auto object-cover" src="{{ asset('images/testimonials-1.jpg') }}" alt="User Image">
          ...
          <div class="swiper-slide flex flex-col space-y-4">
            <img class="w-20 h-20 rounded-full mx-auto object-cover" src="{{ asset('images/testimonials-2.jpg') }}" alt="User Image">
            <h3 class="text-lg font-medium text-gray-700 text-primary">John Doe</h3>
            <h6 class="text-base text-gray-500 max-w-[800px] text-white">
    ...
    <div class="container mx-auto">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <div class="bg-white rounded-lg overflow-hidden shadow-md">
            <img src="{{ asset('images/team-1.png') }}" alt="Team Member 1" class="w-full h-auto">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md">
            <img src="{{ asset('images/team-2.png') }}" alt="Team Member 2" class="w-full h-auto">
            <div class="p-4 text-center">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md">
            <img src="{{ asset('images/team-3.png') }}" alt="Team Member 3" class="w-full h-auto">
            <div class="p-4 text-center">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-md">
            <img src="{{ asset('images/team-4.png') }}" alt="Team Member 4" class="w-full h-auto">
            <div class="p-4 text-center">
  ...
  <footer class="bg-gray-dark text-white py-16">
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="text-center md:text-left">
            ...
            <ul class="space-y-2">
                <li><a href="#" class="hover:text-secondary font-bold">About Our Company</a></li>
                <li><a href="#" class="hover:text-secondary font-bold">Our Team</a></li>
        ...
        <div class="flex flex-col items-center md:items-start">
            <!-- Logo -->
            <img src="{{ asset('images/blue-logo.png') }}" alt="Logo" class="h-14 w-auto mb-4">
            <p>Developed by  <br>Adrian Vera y Daril Diaz</a>
        </div>
    </div>
</footer>
